...
import type { ExecutorConfig, GraffleHeadersInit, GraphQLClient } from "../../../packages/graffle-client/src/types";
...
const createTestOperation = (): AnyOperation => {
  const document = gqlRuntime.castDocumentNode(
    parse(`
    query GetUser($id: ID!) {
      user(id: $id) {
        id
