...
bun run soda-gql codegen \
  --schema:default ./benchmarks/runtime-builder/medium-app/schema.graphql \
  --out ./benchmarks/runtime-builder/medium-app/graphql-system/index.ts \
  --runtime-adapter:default ./benchmarks/runtime-builder/medium-app/runtime-adapter.ts \
  --scalar:default ./benchmarks/runtime-builder/medium-app/runtime-adapter.ts \
  --format typescript
```
