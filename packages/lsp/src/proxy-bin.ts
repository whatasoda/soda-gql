...
connection.onInitialize((params) => {
  ...
  let localLsp: { createLspServer: (options: { connection: typeof connection; initializeParams: typeof params }) => { initializeResult?: { capabilities: Record<string, unknown> } } } | undefined;
 ...
 * Inlined from server.ts to avoid importing @soda-gql/lsp at module level.
 */
