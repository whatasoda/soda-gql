/**
 * Runtime behavior tests for swc-transformer.
 *
...
try {
  ...
  console.warn("[swc-transformer] Native module not available - runtime tests will be skipped:", initError);
}
...
describe("Runtime Behavior", () => {
  ...
  describe("slice", () => {
    it.skipIf(!nativeModuleAvailable)("embed() returns correct variables and projection", async () => {
