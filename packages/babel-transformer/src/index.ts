 ...
 * gql.default() calls to runtime calls. It is used by @soda-gql/babel-plugin
 * and can be used directly for custom integrations.
 *
 * Two interfaces are provided:
 * - `createTransformer`: AST-based, works with Babel's NodePath (used by babel-plugin)
...
// AST-based transformer (for babel-plugin integration)
