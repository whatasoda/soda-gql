...
export type AttachmentToProperty<TAttachment> =
  TAttachment extends { name: infer TName extends string; createValue: (element: any) => infer TValue extends object }
    ? { [K in TName]: TValue }
    : never;
 ...
 */
export type AttachmentsTupleToIntersection<TAttachments extends readonly AttachmentShape[]> =
  TAttachments extends readonly [infer First extends AttachmentShape, ...infer Rest extends readonly AttachmentShape[]]
