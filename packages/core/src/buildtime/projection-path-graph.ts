import type { AnyOperationSliceFragment, ExecutionResultProjectionPathGraphNode } from "../types/operation";
...
export function createPathGraphFromSliceEntries(fragments: { [key: string]: AnyOperationSliceFragment }) {
