...
import { createCurriedOperationTaggedTemplate, createOperationTaggedTemplate } from "./operation-tagged-template";
...
describe("createCurriedOperationTaggedTemplate", () => {
  describe("query curried tagged template", () => {
    const query = createCurriedOperationTaggedTemplate(schema, "query");
  ...
  describe("mutation curried tagged template", () => {
    const mutation = createCurriedOperationTaggedTemplate(schema, "mutation");
  ...
  describe("subscription curried tagged template", () => {
    const subscription = createCurriedOperationTaggedTemplate(schema, "subscription");
