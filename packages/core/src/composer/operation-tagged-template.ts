...
/**
 * Creates a tagged template function for a specific operation type (legacy inline-header syntax).
 *
 ...
 * @param _transformDocument - Optional document transformer (reserved for future use)
 */
export const createCurriedOperationTaggedTemplate = <TSchema extends AnyGraphqlSchema, TOperationType extends OperationType>(
  schema: TSchema,
  operationType: TOperationType,
  _metadataAdapter?: AnyMetadataAdapter,
  // biome-ignore lint/suspicious/noExplicitAny: DocumentTransformer generic params not needed here
