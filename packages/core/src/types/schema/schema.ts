 ...
 * @typeParam TDepth - Depth counter to limit recursion (default from schema overrides or 3 levels)
 *
...
export type InferInputProfile<
  ...
  TDepth extends DepthCounter = GetInputTypeDepth<TSchema["__inputDepthOverrides"], TSpecifier["name"]>,
