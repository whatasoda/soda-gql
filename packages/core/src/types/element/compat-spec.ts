...
/**
 * Brand symbol for CompatSpec to distinguish from other GqlDefine values.
 */
declare const __COMPAT_SPEC_BRAND__: unique symbol;
...
> = {
  readonly [__COMPAT_SPEC_BRAND__]: void;
