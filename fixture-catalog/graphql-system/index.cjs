...
__export(index_exports, {
  __directiveMethods_admin: () => customDirectives_admin,
  __directiveMethods_default: () => customDirectives_default,
  __fullSchema_admin: () => fullSchema_admin,
...
// fixture-catalog/schemas/default/scalars.ts
...
// fixture-catalog/schemas/admin/scalars.ts
var import_core2 = require("@soda-gql/core");
var scalar2 = {
  // Built-in scalars
  ...(0, import_core2.defineScalar)("ID"),
  ...(0, import_core2.defineScalar)("String"),
  ...(0, import_core2.defineScalar)("Int"),
  ...(0, import_core2.defineScalar)("Float"),
  ...(0, import_core2.defineScalar)("Boolean"),
  // Custom scalars
  ...(0, import_core2.defineScalar)("DateTime"),
  ...(0, import_core2.defineScalar)("JSON"),
  ...(0, import_core2.defineScalar)("BigInt")
};

// fixture-catalog/graphql-system/_defs/enums.ts
var import_core3 = require("@soda-gql/core");
var enum_default_CacheScope = (0, import_core3.defineEnum)("CacheScope", { PRIVATE: true, PUBLIC: true, USER: true });
var enum_default_EmployeeRole = (0, import_core3.defineEnum)("EmployeeRole", { DIRECTOR: true, ENGINEER: true, EXECUTIVE: true, INTERN: true, MANAGER: true });
var enum_default_LogLevel = (0, import_core3.defineEnum)("LogLevel", { DEBUG: true, ERROR: true, INFO: true, WARN: true });
var enum_default_ProjectStatus = (0, import_core3.defineEnum)("ProjectStatus", { CANCELLED: true, COMPLETED: true, IN_PROGRESS: true, ON_HOLD: true, PLANNING: true });
var enum_default_SortOrder = (0, import_core3.defineEnum)("SortOrder", { ASC: true, DESC: true });
var enum_default_TaskPriority = (0, import_core3.defineEnum)("TaskPriority", { HIGH: true, LOW: true, MEDIUM: true, URGENT: true });
var enum_admin_EmployeeRole = (0, import_core3.defineEnum)("EmployeeRole", { DIRECTOR: true, ENGINEER: true, EXECUTIVE: true, INTERN: true, MANAGER: true });
var enum_admin_ProjectStatus = (0, import_core3.defineEnum)("ProjectStatus", { CANCELLED: true, COMPLETED: true, IN_PROGRESS: true, ON_HOLD: true, PLANNING: true });
var enum_admin_TaskPriority = (0, import_core3.defineEnum)("TaskPriority", { HIGH: true, LOW: true, MEDIUM: true, URGENT: true });

// fixture-catalog/graphql-system/_defs/inputs.ts
...
// fixture-catalog/graphql-system/_defs/objects.ts
...
var object_admin_Comment = { name: "Comment", fields: {
  author: { spec: "o|Employee|!", arguments: {} },
  body: { spec: "s|String|!", arguments: {} },
  createdAt: { spec: "s|DateTime|!", arguments: {} },
  id: { spec: "s|ID|!", arguments: {} },
...
var object_admin_Company = { name: "Company", fields: {
  createdAt: { spec: "s|DateTime|!", arguments: {} },
  departments: { spec: "o|Department|![]!", arguments: {} },
  employees: { spec: "o|Employee|![]!", arguments: { limit: "s|Int|?" } },
  id: { spec: "s|ID|!", arguments: {} },
  industry: { spec: "s|String|?", arguments: {} },
  name: { spec: "s|String|!", arguments: {} },
  updatedAt: { spec: "s|DateTime|?", arguments: {} }
} };
var object_admin_Department = { name: "Department", fields: {
  budget: { spec: "s|BigInt|?", arguments: {} },
  company: { spec: "o|Company|!", arguments: {} },
  createdAt: { spec: "s|DateTime|!", arguments: {} },
  id: { spec: "s|ID|!", arguments: {} },
...
var object_admin_Employee = { name: "Employee", fields: {
  comments: { spec: "o|Comment|![]!", arguments: {} },
  createdAt: { spec: "s|DateTime|!", arguments: {} },
  department: { spec: "o|Department|?", arguments: {} },
  email: { spec: "s|String|!", arguments: {} },
...
var object_admin_Mutation = { name: "Mutation", fields: {
  addComment: { spec: "o|Comment|!", arguments: { body: "s|String|!", taskId: "s|ID|!" } },
  createProject: { spec: "o|Project|!", arguments: { teamId: "s|ID|!", title: "s|String|!" } },
  createTask: { spec: "o|Task|!", arguments: { projectId: "s|ID|!", title: "s|String|!" } },
  deleteComment: { spec: "s|Boolean|!", arguments: { id: "s|ID|!" } },
  deleteProject: { spec: "s|Boolean|!", arguments: { id: "s|ID|!" } },
  deleteTask: { spec: "s|Boolean|!", arguments: { id: "s|ID|!" } },
  updateProject: { spec: "o|Project|!", arguments: { id: "s|ID|!", title: "s|String|?" } },
  updateTask: { spec: "o|Task|!", arguments: { completed: "s|Boolean|?", id: "s|ID|!", title: "s|String|?" } }
} };
var object_admin_Project = { name: "Project", fields: {
  assignees: { spec: "o|Employee|![]!", arguments: {} },
  createdAt: { spec: "s|DateTime|!", arguments: {} },
  description: { spec: "s|String|?", arguments: {} },
  id: { spec: "s|ID|!", arguments: {} },
...
var object_admin_Query = { name: "Query", fields: {
  comment: { spec: "o|Comment|?", arguments: { id: "s|ID|!" } },
  companies: { spec: "o|Company|![]!", arguments: { limit: "s|Int|?" } },
  company: { spec: "o|Company|?", arguments: { id: "s|ID|!" } },
  department: { spec: "o|Department|?", arguments: { id: "s|ID|!" } },
  departments: { spec: "o|Department|![]!", arguments: { companyId: "s|ID|?", limit: "s|Int|?" } },
  employee: { spec: "o|Employee|?", arguments: { id: "s|ID|!" } },
  employees: { spec: "o|Employee|![]!", arguments: { departmentId: "s|ID|?", limit: "s|Int|?" } },
  node: { spec: "s|Node|?", arguments: { id: "s|ID|!" } },
  project: { spec: "o|Project|?", arguments: { id: "s|ID|!" } },
  projects: { spec: "o|Project|![]!", arguments: { limit: "s|Int|?" } },
  task: { spec: "o|Task|?", arguments: { id: "s|ID|!" } },
  tasks: { spec: "o|Task|![]!", arguments: { limit: "s|Int|?", projectId: "s|ID|?" } },
  team: { spec: "o|Team|?", arguments: { id: "s|ID|!" } },
  teams: { spec: "o|Team|![]!", arguments: { departmentId: "s|ID|?", limit: "s|Int|?" } }
} };
var object_admin_Subscription = { name: "Subscription", fields: {
  commentAdded: { spec: "o|Comment|!", arguments: { taskId: "s|ID|!" } },
  projectUpdated: { spec: "o|Project|!", arguments: { projectId: "s|ID|!" } },
  taskCreated: { spec: "o|Task|!", arguments: { projectId: "s|ID|?" } }
} };
var object_admin_Task = { name: "Task", fields: {
  assignee: { spec: "o|Employee|?", arguments: {} },
  comments: { spec: "o|Comment|![]!", arguments: { limit: "s|Int|?" } },
  completed: { spec: "s|Boolean|!", arguments: {} },
  createdAt: { spec: "s|DateTime|!", arguments: {} },
...
var object_admin_Team = { name: "Team", fields: {
  department: { spec: "o|Department|!", arguments: {} },
  id: { spec: "s|ID|!", arguments: {} },
  lead: { spec: "o|Employee|?", arguments: {} },
  members: { spec: "o|Employee|![]!", arguments: { limit: "s|Int|?" } },
...
// fixture-catalog/graphql-system/_defs/unions.ts
...
var customDirectives_default = { ...(0, import_core4.createStandardDirectives)(), ...{
  ...
  cached: (0, import_core4.createTypedDirectiveMethod)("cached", ["FIELD"], {
    scope: "e|CacheScope|?",
    ttl: "s|Int|!"
  }),
  constraint: (0, import_core4.createTypedDirectiveMethod)("constraint", ["VARIABLE_DEFINITION"], {
    max: "s|Int|?",
    min: "s|Int|?",
    pattern: "s|String|?"
  }),
  defer: (0, import_core4.createTypedDirectiveMethod)("defer", ["FRAGMENT_SPREAD", "INLINE_FRAGMENT"], {
    if: "s|Boolean|?",
    label: "s|String|?"
  }),
  internal: (0, import_core4.createDirectiveMethod)("internal", ["FIELD", "OBJECT"]),
  log: (0, import_core4.createTypedDirectiveMethod)("log", ["FIELD", "QUERY", "MUTATION", "SUBSCRIPTION"], {
    level: "e|LogLevel|?"
  }),
  rateLimit: (0, import_core4.createTypedDirectiveMethod)("rateLimit", ["FIELD", "QUERY", "MUTATION"], {
    duration: "s|Int|!",
    limit: "s|Int|!",
    message: "s|String|?"
  }),
  stream: (0, import_core4.createTypedDirectiveMethod)("stream", ["FIELD"], {
    if: "s|Boolean|?",
    initialCount: "s|Int|?",
    label: "s|String|?"
  }),
  tag: (0, import_core4.createTypedDirectiveMethod)("tag", ["FIELD", "OBJECT", "INTERFACE"], {
    name: "s|String|!"
  })
} };
