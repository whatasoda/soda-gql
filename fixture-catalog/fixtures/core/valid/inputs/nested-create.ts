...
export const createProjectWithTasksMutation = gql.default(({ mutation }) =>
  mutation("CreateProjectWithTasks")`($teamId: ID!, $title: String!, $description: String, $status: ProjectStatus, $priority: Int) {
...
export const updateTaskMutation = gql.default(({ mutation }) =>
  mutation("UpdateTask")`($taskId: ID!, $title: String, $completed: Boolean, $priority: TaskPriority) {
