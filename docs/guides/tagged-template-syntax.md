...
The generated types are backed by these `@soda-gql/core` exports, available for advanced typing: `PrebuiltOperationOptions`, `PrebuiltFragmentOptions`, `ComposeTimeVarRefsFromVarTypes`, `VarRefPayload`, and `SelectorProxy`.
