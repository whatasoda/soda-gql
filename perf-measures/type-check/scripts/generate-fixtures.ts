...
${mutationFields.join("\n")}
  ...
  // Generate FragmentBuilders type entries
  const fragmentBuilderEntries = objectRefs.map(
    (name) => `  readonly ${name}: FragmentBuilderFor<Schema, "${name}">;`
  ).join("\n");

  return `// Auto-generated schema for type-check benchmarking
// DO NOT EDIT - this file is generated by generate-fixtures.ts

import { createGqlElementComposer, createVarMethodFactory, type FragmentBuilderFor, type InputTypeMethods } from "@soda-gql/core";
